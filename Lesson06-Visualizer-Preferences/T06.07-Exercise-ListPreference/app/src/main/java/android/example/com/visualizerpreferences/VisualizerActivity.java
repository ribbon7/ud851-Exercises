...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void loadColorFromPreferences(SharedPreferences sharedPreferences){
        String loadedColor = sharedPreferences.getString(getString(R.string.pref_color_key), getString(R.string.pref_color_red_value));
        mVisualizerView.setColor(loadedColor);
    }
