...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            if(savedInstanceState.containsKey(RAW_JSON_KEY)){
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String urlString = mUrlDisplayTextView.getText().toString();
        String jsonString = mSearchResultsTextView.getText().toString();

        outState.putString(QUERY_URL_KEY, urlString);
        outState.putString(RAW_JSON_KEY, jsonString);
    }
}