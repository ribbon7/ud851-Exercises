...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        Intent launchServiceIntent = new Intent(context, WaterReminderIntentService.class);
        //      TODO (7) Set the action of the intent to designate you want to dismiss the notification
        launchServiceIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        Intent launchServiceIntent = new Intent(context, WaterReminderIntentService.class);
        launchServiceIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
