...
public class MainActivity extends AppCompatActivity implements
    ...
    public void showCharging(boolean isCharging){
        if(isCharging){
            mChargingImageView.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_power_pink_80px));
        } else {
            mChargingImageView.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_power_grey_80px));
        }
    }
